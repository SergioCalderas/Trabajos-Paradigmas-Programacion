...
*/
public class Grada extends Zona{
    private char seccion;
    private int fila;
    private int asiento;

    // CONSTRUCTOR de Grada
    public Grada(String nombreZona, double costo, char seccion, int fila, int asiento){
